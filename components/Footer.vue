<template>
  <div>
    <div class="m-5 flex gap-3 text-gray4 text-xl justify-center">
      ...
      <div>
        <div class="layer-top">
          <div class="brand">
            ...
            <p class="text">
              Do you have a plan to become cross-media? We think we know that if
              you drive micro-mega then you may also mesh iteravely.
            </p>

            <div class="socials">
              <a
                href="#"
                class="soc-link i-carbon-portfolio"
                aria-label="Linkden"
              >
              </a>
...
.app-footer-def {
  @apply bg-sky-100 dark:bg-brand-pri;

  > div {
    @apply container px-8 py-8 mx-auto !max-w-screen-xl;
  }
}
...
.brand {
  ...
  .text {
    @apply max-w-md mt-2 text-gray-600 dark:text-gray-300;
  }
  ...
  .soc-link {
    @apply mx-2 text-gray-700 dark:text-gray-200
...
.divider-1 {
  @apply h-px my-6 bg-gray-300 border-none
    dark:bg-gray-700 mx-10;
}
</style>